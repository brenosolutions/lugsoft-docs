...
# Adicionar Anúncio [#add]
1. Navegue no menu pela barra lateral esquerda e clique na opção "Publicar -> Publicidades".
2. Em seguida, clique no botão "Adicionar" para começar a adicionar uma nova anúncio.
3 . Preencha os detalhes.
    ...
    - **Categoria:** A categoria é uma classificação que ajuda a organizar e categorizar. Por exemplo, você pode ter categorias como "Varejo", "Promoções", "Entretenimento", etc. [Como adicionar uma nova categoria](categories#add)
...
<Callout type="info" emoji="ℹ️">
    **Observação** \
    Para começar a exibir os anúncios na plataforma, é necessário adicionar um widget de publicidade na posição desejada do layout. Certifique-se de configurar o widget com a categoria e tamanho especificados na criação do anúncio anteriomente. [Como adicionar um widget de publiciade](../widgets#ads)

    Não é necessário adicionar vários widgets de publicidade para cada anúncio criado. Basta configurar um único widget por categoria e tamanho. Os anúncios serão exibidos aleatoriamente dentro do mesmo grupo. A menos que você queira exibir o mesmo anúncio em vários locais do site, nesse caso, será necessário adicionar widgets adicionais para esses locais específicos.
</Callout>
