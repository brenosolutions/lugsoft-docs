...
2. Em seguida, clique no botão "Adicionar" para começar a adicionar uma novo evento.
3. Preencha os detalhes, incluindo título, descrição, conteúdo, datas e horários, categoria e configurações de comentários.
    - **Capa:** Envie uma imagem no tamanho `569x320px`que será exibida como destaque na capa do evento.
