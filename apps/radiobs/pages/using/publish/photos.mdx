...
3. Preencha os detalhes, incluindo título, descrição, data de publicação.
    ...
    - **Categoria:** A categoria é uma classificação que ajuda a organizar e categorizar. Por exemplo, você pode ter categorias como "Eventos", "Família", "Entretenimento", etc. [Como criar uma nova categoria](categories#create)
