...
3. Preencha os detalhes, incluindo nome do programa, apresentador, hora inicial e final e os dias da semana.
    ...
    - **Apresentador:** Selecione o apresentador da lista (Usuários da administração). [Como criar um novo apresentador](../users/administration/#create)
