...
2.  Você irá visualizar 2 colunas.
    ...
    -   **Não Utilizado:** Lista de músicas desativadas.
        ...
        <Callout type="info" emoji="ℹ️">
            **Observação** \ Alternar entre as listas "Top Música" e "Não Utilizado" é simples. Além
            disso, você pode organizar a ordem da lista arrastando e soltando os itens conforme
            desejado.
        </Callout>
...
4.  Preencha os detalhes, incluindo nome da música, tipo de áudio.
    ...
    -   **Capa:** Envie uma imagem no tamanho `240x240px` que será exibida como destaque na capa da música.
